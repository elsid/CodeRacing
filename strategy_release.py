...
BUGGY_INITIAL_ANGLE_TO_DIRECT_PROPORTION = 4
JEEP_INITIAL_ANGLE_TO_DIRECT_PROPORTION = 4
...
class MoveMode:
    ...
    def move(self, context: Context):
        ...
        if (context.world.tick > context.game.initial_freeze_duration_ticks and
            ...
            context.move.use_nitro = (nitro_cos > 0.45 and
                                      target_speed.norm() > 30 and
                                      context.direction.cos(course) > 0.99)
